 ...
 * @param {string} str
 */
 window.JSON.stringify = function(str){};
  /**
 * JSON.parse
 * @param {object} ob
 */
 window.JSON.parse = function(ob){}; 
 ...
 */
 ...
 /**
 * @param {*} options
 * @return {(jQuerySelector|Array.<Element>|string|jQuery)}
 */
jQuery.prototype.button = function(options) {};
