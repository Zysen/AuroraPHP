...
(function($) {
    ...
    function jqPlot() {
        ...
        this.draw = function(){
            if (true || this.drawIfHidden || this.target.is(':visible')) {
                ...
                if (this.title.show) {
                    gridPadding.top += (2.5*this.title.getHeight());
                }
                if (ax.xaxis.show) {
    ...
    */
    ...
    function _normalizeArguments( effect, options, speed, callback ) {
        ...
        // catch (effect, speed, ?)
        if ( jQuery.type( options ) === "number" || jQuery.fx.speeds[ options ]) {
            callback = speed;
            speed = options;
            options = {};
        }
        ...
        effect.duration = jQuery.fx.off ? 0 : typeof speed === "number"
    ...
    jQuery.fn.extend({
        jqplotEffect: function( effect, options, speed, callback ) {
            ...
            if ( jQuery.fx.off || !( effectMethod || oldEffectMethod ) ) {
